...
function [S,T]=testsingle_improved()
    ...
    function G=g2(field,t)
        G=[zeros(k,1);zeros(k,1);2*sgam*n*realnoise(t)];
    end
    ...
    [S,T]=rk4int(initf,@f,2,{@g1 @g2},nnoise,[314159265 45729819],0,interval,nsteps,{@meann,@varn,@fieldsamp,@weightsamp},[100 100 100 100],true,{@breed});
