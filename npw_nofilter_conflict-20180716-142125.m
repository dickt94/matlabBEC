function [samples,times]=npw_nofilter()
    ...
    function F=f(c,t)
        ...
        %end
        norm=sum((conj(c(1:end-1,:)).*c(1:end-1,:))*w);
...
%         m_pjb=m_pj;
    ...
    [samples,times]=rk4int(c0,@f,ipevol,true,2,{@fieldnoise @weightevol},{[nmodes npaths],[nmodes 1]},[103029 837189039],0,time_int,12500,{@norm,@field,@eE,@obdm},[500 500 500 100],{@breed},false);
